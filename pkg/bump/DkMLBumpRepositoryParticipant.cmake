...
function(DkMLBumpRepositoryParticipant_AddPackageVersion)
    ...
    foreach(OPAM_PACKAGE IN LISTS ARG_OPAM_PACKAGES)
        ...
        # Example:
        # https://gitlab.com/dkml/distributions/dkml/-/releases/1.2.1-10/downloads/src.dkml-runtime-common.tar.gz
        set(URL_SRC https://gitlab.com/dkml/distributions/dkml/-/releases/${DKML_VERSION_SEMVER_NEW}/downloads/src.${ARG_PROJECT}.tar.gz)
