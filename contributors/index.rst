...
Then run the `latest Windows 64-bit installer <https://github.com/diskuv/dkml-installer-ocaml/releases/download/v0.4.1/setup-diskuv-ocaml-windows_x86_64-0.4.1.exe>`__.
